...
class ScannerLogicTests(unittest.TestCase):
    ...
    def test_teaching_reference_chart_keeps_prices_and_context_without_dashboard_footer(self):
        ...
        self.assertIn('level_bar(level, resistance_thickness * 0.72, "#c7505c", 0.42', source)
        self.assertIn('level_bar(level, support_thickness * 0.72, "#2c9c64", 0.42', source)
        self.assertIn('level_bar(resistance_level, resistance_thickness, "#ff5862", 0.86', source)
        self.assertIn('level_bar(support_level, support_thickness, "#33d17a", 0.86', source)
